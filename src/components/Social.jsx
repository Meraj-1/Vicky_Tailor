...
const Social = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center bg-white text-[#1d1d1f] touch-pan-y"
    >
      <div className="absolute inset-0 bg-[radial-gradient(50%_50%_at_50%_50%,#f5f5f7_0%,#ffffff_100%)]" />

      {/* HEADER */}
      <div className="z-10 mb-10 flex flex-col items-center text-center px-4 select-none pointer-events-none">
      ...
      <div className="relative w-full flex-1 flex items-center justify-center overflow-visible">
        {posts.map((post, i) => {
          ...
          return (
            ...
            >
              <div 
                className={`relative w-[280px] h-[500px] md:w-[320px] md:h-[580px] rounded-[2.5rem] overflow-hidden transition-all duration-700
              ...
              >
                ...
                {isActive && (
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40 p-8 flex flex-col justify-end pointer-events-none">
